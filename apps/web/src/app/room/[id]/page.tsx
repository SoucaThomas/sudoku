        ...
        <>
            {isMounted ? (
                <section className="w-5/6 md:w-3/4 max-w-7xl mx-auto my-10">
                    ...
                    <div className="h-full md:grid md:grid-cols-6 md:grid-rows-6 lg:grid md:gap-4 mt-4">
                        <div className=" max-md:h-1/2 md:row-span-3 md:col-span-4">
                            <Game />
                        </div>
                        <div className=" hidden md:block md:row-span-3 md:col-span-2">
                            <Chat />
                        </div>
                        <div className="bg-blue-400/20 m-2 h-1/5 md:hidden">
                            {" "}
                            controls for mobile
                        </div>
                    </div>
